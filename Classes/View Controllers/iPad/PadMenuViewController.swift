        ...
        if Settings.shared().isOfflineMode {
            ...
            case 2:
                if let cachedController = cachedTabs["FoldersViewController"] {
                    ...
                    controller = CustomUINavigationController(rootViewController: FoldersViewController())
            ...
            case 6:
                if let cachedController = cachedTabs["PlayingViewController"] {
                    ...
                    controller = CustomUINavigationController(rootViewController: PlayingViewController())
